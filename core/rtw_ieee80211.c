...
static const char *const _rate_section_str[] = {
	...
	[VHT_3SS]	= "VHT_3SS",
	[VHT_4SS]	= "VHT_4SS",
	[RATE_SECTION_NUM]	= "RATE_SECTION_UNKNOWN",
};
...
#define RATES_BY_SEC_ENT(rs, ntx, rate_array) \
	[rs]	= {ntx, ARRAY_SIZE(rate_array), rate_array}

struct rate_section_ent rates_by_sections[RATE_SECTION_NUM] = {
	RATES_BY_SEC_ENT(CCK,		RF_1TX, mgn_rates_cck),
	RATES_BY_SEC_ENT(OFDM,		RF_1TX, mgn_rates_ofdm),
	RATES_BY_SEC_ENT(HT_1SS,	RF_1TX, mgn_rates_mcs0_7),
	RATES_BY_SEC_ENT(HT_2SS,	RF_2TX, mgn_rates_mcs8_15),
	RATES_BY_SEC_ENT(HT_3SS,	RF_3TX, mgn_rates_mcs16_23),
	RATES_BY_SEC_ENT(HT_4SS,	RF_4TX, mgn_rates_mcs24_31),
	RATES_BY_SEC_ENT(VHT_1SS,	RF_1TX, mgn_rates_vht1ss),
	RATES_BY_SEC_ENT(VHT_2SS,	RF_2TX, mgn_rates_vht2ss),
	RATES_BY_SEC_ENT(VHT_3SS,	RF_3TX, mgn_rates_vht3ss),
	RATES_BY_SEC_ENT(VHT_4SS,	RF_4TX, mgn_rates_vht4ss),
};
