...
/**
 * @enum WICENSE_REQ_STATE
 *
 * @brief WICENSE_REQ_STATE
 *
 * @var WICENSE_REQ_STATE::WICENSE_STATE_INIT
 * Please Place Description here.
 * @var WICENSE_REQ_STATE::WICENSE_STATE_PAUSE
 * Please Place Description here.
 * @var WICENSE_REQ_STATE::WICENSE_STATE_RESUME
 * Please Place Description here.
 * @var WICENSE_REQ_STATE::WICENSE_STATE_MAX
 * Please Place Description here.
 */
enum WICENSE_REQ_STATE {
	WICENSE_STATE_INIT = 0,
	WICENSE_STATE_PAUSE = 1,
	WICENSE_STATE_RESUME = 2,
	WICENSE_STATE_MAX
};
 ...
 * @brief WICENSE_MODE
 *
 * @var WICENSE_MODE::WICENSE_MODE_SCC
 * Please Place Description here.
 * @var WICENSE_MODE::WICENSE_MODE_DBCC
 * Please Place Description here.
 * @var WICENSE_MODE::WICENSE_MODE_MCC
 * Please Place Description here.
 * @var WICENSE_MODE::WICENSE_MODE_DBG
 * Please Place Description here.
 * @var WICENSE_MODE::WICENSE_MODE_MAX
 * Please Place Description here.
 */
enum WICENSE_MODE {
	WICENSE_MODE_SCC = 0,
