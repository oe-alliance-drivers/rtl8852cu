...
static struct mac_ax_hfc_ch_cfg hfc_chcfg_usb_la_8852bt[] = {
	{24, 412, grp_0}, /* ACH 0 */
	{24, 412, grp_0}, /* ACH 1 */
	{24, 412, grp_0}, /* ACH 2 */
	{24, 412, grp_0}, /* ACH 3 */
...
static struct mac_ax_hfc_pub_cfg hfc_pubcfg_usb_la_8852bt = {
	412, /* Group 0 */
	0, /* Group 1 */
	412, /* Public Max */
	0 /* WP threshold */
	...
	case MAC_AX_INTF_USB:
		...
		if (is_chip_id(adapter, MAC_AX_CHIP_ID_8852BT)) {
			...
			case MAC_AX_QTA_DLFW:
				...
				break;
			case MAC_AX_QTA_LAMODE:
				ch_cfg_ini = hfc_chcfg_usb_la_8852bt;
				pub_cfg_ini = &hfc_pubcfg_usb_la_8852bt;
				prec_cfg_ini = &hfc_preccfg_usb_8852bt;
				break;
			default:
				return MACHFCCH011QTA;
