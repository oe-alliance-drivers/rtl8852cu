			...
			struct mac_ax_fixmode_para *info)
{
	...
	cpu_to_le32((info->fix_txcmdnum_en ?
		    ...
		    (info->fix_ruratiorequestbydriverMode ?
		     FWCMD_H2C_FIXMODE_PARA_FIX_RURATIOREQUESTBYDRIVERMODE : 0) |
		    (info->ruratiorequestbydriverMode_en ?
		     FWCMD_H2C_FIXMODE_PARA_RURATIOREQUESTBYDRIVERMODE_EN : 0));

	tbl->dword4 =
	cpu_to_le32(SET_WORD(info->ruratiorequestbydriverModeRatio,
			     FWCMD_H2C_FIXMODE_PARA_RURATIOREQUESTBYDRIVERMODERATIO));
