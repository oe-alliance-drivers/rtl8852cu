...
static struct mac_ax_intf_ops mac8852c_usb_ops = {
	...
	get_u3_perf_mode_8852c,/*get_u3_perf_mode*/
...
static struct mac_ax_intf_ops mac8852c_pcie_ops = {
	...
	lv2rst_stop_dma_pcie_8852c, /*lv2rst_stop_dma*/
};
#endif
...
#if MAC_FEAT_THERMAL_PROTECT
	mac_tx_duty, /* tx_duty */
	mac_tx_duty_stop, /* tx_duty _stop */
#endif /* MAC_FEAT_THERMAL_PROTECT */
	mac_h2c_agg_enable,
	mac_h2c_agg_flush,
	mac_h2c_agg_tx,
	mac_role_sync,
...
static struct mac_ax_hw_info mac8852c_hw_info = {
	...
	0x1FFF, /* txdma_ch_map */
	0x3, /* rxdma_ch_map */
	SHARE_MEM_SIZE_8852C, /* fifo_size */
	WL_EFUSE_FULL_SIZE_8852C, /* wl_efuse_size */
	WL_EFUSE_LOG_SIZE_8852C, /* efuse_size */
	WL_EFUSE_LOG_MAP_SIZE_8852C, /* log_efuse_size */
	BT_EFUSE_FULL_SIZE_8852C, /* bt_efuse_size */
	BT_EFUSE_LOG_MAP_SIZE_8852C, /* bt_log_efuse_size */
	WL_HIDDEN_EFUSE_RF_SIZE_8852C, /* hidden_efuse_rf_size */
	WL_HIDDEN_EFUSE_MAC_SIZE_8852C, /*hidden_efuse_mac_size*/
	WL_SEC_CTRL_EFUSE_SIZE_8852C, /* sec_ctrl_efuse_size */
	WL_SEC_DATA_EFUSE_SIZE_8852C, /* sec_data_efuse_size */
	DAV_FULL_EFUSE_SIZE_8852C, /* dav_full_efuse_size */
	DAV_EFUSE_LOG_SIZE_8852C, /* dav_efuse_size  */
	DAV_HIDDEN_EFUSE_SIZE_8852C, /* dav_hidden_efuse_size  */
	DAV_EFUSE_LOG_MAP_SIZE_8852C, /* dav_log_efuse_size  */
	CFG_DCTL_INFO_SIZE_8852C, /* dctl_info_size */
	0, /* sw_amsdu_max_size */
	...
	A_DIE_RL1_8852C, /* aid */
	MACID_NUM_8852C, /* macid_num */
	MAX_TX_AMPDU_NUM_8852C, /*max_tx_ampdu_num*/
	MAX_TX_AMPDU_NUM_C1_8852C, /*max_tx_ampdu_num_c1*/
	0, /* done */
	WL_EFUSE_MAP_VER_SIZE_8852C, /* efuse_version_size */
	D_DIE_CHIP_ID_8852C, /* chip_id */
	0xFF, /* cv */
	0, /* acv */
	0xFF, /* fv */
	TX_DMA_CH_NUM_8852C, /* tx_ch_num */
	TX_DMA_DATA_CH_NUM_8852C, /* tx_data_ch_num */
	WD_BODY_LEN_V1, /* wd_body_len */
	WD_INFO_LEN, /* wd_info_len */
	PWR_SEQ_VER_8852C, /* pwr_seq_ver */
	HW_BAND_NUM_8852C, /* hw_band_num */
	PORT_NUM_8852C, /* port_num */
	MBSSID_NUM_8852C, /* mbssid_num */
	BSSIDCAM_NUM_8852C, /* bssid_num */
	WP_SEC_RSVD_SIZE_8852C, /* ple_rsvd_space */
	WP_PLD_DESC_SIZE_8852C, /* payload_desc_size */
	0, /* wd_checksum_en */
	0, /* core_swr_volt */
	MAX_AGG_TXTIME_HW_8852C, /*max_agg_txtime_reg*/
	0, /* bcn_pkt_drop */
};
...
static struct mac_ax_adapter mac_8852c_adapter = {
	...
	{{0}}, /* ser_info */
	{0}, /* efuse_param */
	{pwr_on_seq_8852c, pwr_off_seq_8852c,
					     ...
					     struct mac_ax_pltfm_cb *pltfm_cb)
{
	...
	adapter->hw_info->macid_num = SPEC_MAX_MACID_NUM_AP_8852C;
#else /*for NIC mode setting*/
	adapter->hw_info->macid_num = SPEC_MAX_MACID_NUM_NIC_8852C;
#endif
