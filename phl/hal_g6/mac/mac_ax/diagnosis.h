...
u32 diagnosis_TX_Hang_HAXIDMA_Common(struct mac_ax_adapter *adapter, u32 *checker_number, char *output, u32 out_len, u32 *used);
u32 diagnosis_TX_Hang_HAXIDMA_Dispatcher(struct mac_ax_adapter *adapter, u32 *checker_number, char *output, u32 out_len, u32 *used);
u32 diagnosis_TX_Hang_HAXIDMA_STA_scheduler(struct mac_ax_adapter *adapter, u32 *checker_number, char *output, u32 out_len, u32 *used);
u32 diagnosis_TX_Hang_HAXIDMA_SCH(struct mac_ax_adapter *adapter, u32 *checker_number, char *output, u32 out_len, u32 *used);
u32 diagnosis_TX_Hang_HAXIDMA_PTCL(struct mac_ax_adapter *adapter, u32 *checker_number, char *output, u32 out_len, u32 *used);
u32 diagnosis_TX_Hang_HAXIDMA_TRXPTCL(struct mac_ax_adapter *adapter, u32 *checker_number, char *output, u32 out_len, u32 *used);
u32 diagnosis_TX_Hang_HAXIDMA_RMAC(struct mac_ax_adapter *adapter, u32 *checker_number, char *output, u32 out_len, u32 *used);
