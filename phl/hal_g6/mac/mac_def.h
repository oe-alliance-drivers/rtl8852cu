...
#define MAC_AX_DIAG_LEAVE_PS_FAIL_VER 0
#define MAC_AX_DIAG_NULL_VER 0
#endif
 ...
 *
 * @var mac_ax_diag_event_type::MAC_AX_DIAG_EVT_SER_L2
 * Diagnostic event type of SER
 */
enum mac_ax_diag_event_type {
	MAC_AX_DIAG_EVT_SER_L2 = 0,     /* SER L2 */
	MAC_AX_DIAG_EVT_SER_L1 = 1,  /* SER L1 */
	MAC_AX_DIAG_EVT_LEAVE_PS_FAIL = 2, /* LEAVE PS FAIL */
	MAC_AX_DIAG_EVT_NULL = 0x7FFFFFFF, /* NULL EVENT */
};
...
struct mac_ax_hw_info {
	...
	u16 aid;
	u16 macid_num;
	u16 max_tx_ampdu_num;
	u16 max_tx_ampdu_num_c1;
	u8 done;
...
struct sensing_csi_info{
	...
	enum mac_ax_wicense_dbg_rpt_mode dbg_rpt_mode;
...
struct mac_ax_ops {
	...
	u32 (*req_sta_diagnosis)(struct mac_ax_adapter *adapter,
				 u32 diag_level, u32 *total_check_num, u32 *err_num,
