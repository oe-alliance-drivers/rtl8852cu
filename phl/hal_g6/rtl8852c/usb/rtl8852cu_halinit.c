				 ...
				 struct hal_init_info_t *init_52cu)
{
	...
	rpr_cfg->txok_en = (phl_com->dbg_cfg.rls_rpt_en == true)
			       ? MAC_AX_FUNC_EN
			       : MAC_AX_FUNC_DEF;
	rpr_cfg->rty_lmt_en = (phl_com->dbg_cfg.rls_rpt_en == true)
				  ? MAC_AX_FUNC_EN
				  : MAC_AX_FUNC_DEF;
	rpr_cfg->lft_drop_en = (phl_com->dbg_cfg.rls_rpt_en == true)
				   ? MAC_AX_FUNC_EN
				   : MAC_AX_FUNC_DEF;
	rpr_cfg->macid_drop_en = (phl_com->dbg_cfg.rls_rpt_en == true)
				     ? MAC_AX_FUNC_EN
				     : MAC_AX_FUNC_DEF;
					 ...
					 struct hal_info_t *hal_info)
{
	...
	_hal_pre_init_8852cu(phl_com, hal_info, &init_52ce);

	return hal_fast_start_8852c(phl_com, hal_info, &init_52ce);
}
