...
struct rtw_phl_evt_ops {
	...
	bool (*sec_check_iv_valid)(void *priv, void *rxpkt);
#endif
};
...
enum phl_msg_evt_id {
	...
	MSG_EVT_SCAN_END = 4,
	MSG_EVT_P2P_SCAN_START = 5,
	MSG_EVT_P2P_SCAN_END = 6,
	MSG_EVT_CONNECT_START = 7,
	MSG_EVT_CONNECT_LINKED = 8,
	MSG_EVT_CONNECT_END = 9,
	MSG_EVT_SER_L1 = 10,
	MSG_EVT_SER_L2 = 11,
	MSG_EVT_FWDL_OK = 12,
	MSG_EVT_FWDL_FAIL = 13,
	MSG_EVT_HAL_INIT_OK = 14,
	MSG_EVT_HAL_INIT_FAIL = 15,
	MSG_EVT_MP_CMD_DONE = 16,
	...
	/* MRC DBCC */
	MSG_EVT_DBCC_PROTOCOL_HDL = 109,/*TODO-useless delete it*/
