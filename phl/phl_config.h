...
/* memory size level */
#define _PHL_MEM_SIZE_NONE_     0
#define _PHL_MEM_SIZE_MIN_      1       // Only support simple link ability and one IC.
#define _PHL_MEM_SIZE_COMPACT_  2
#define _PHL_MEM_SIZE_FULL_     3
...
/******************* PLATFORM Section **************************/
	...
	#ifdef RT_MEM_SIZE_MAXMIUM /* temp: windows legacy definition */
		#define PHL_MEM_SIZE_LEVEL _PHL_MEM_SIZE_FULL_
	#else
		#define PHL_MEM_SIZE_LEVEL RT_MEM_SIZE_LEVEL
	#endif
	...
	#define CONFIG_TAS_SUPPORT
	...
	#endif
	#if ANTTEST_SUPPORT || defined(CONFIG_CUS_FB) || defined(CONFIG_CUS_FB)
		...
		/* PKT_USE_SHMEM_POOL depend on CONFIG_PHL_TEST_SUITE */
		#ifndef RTW_TEST_TX_PKT_USE_SHMEM_POOL
			#define RTW_TEST_TX_PKT_USE_SHMEM_POOL
		#endif
	#endif /* CONFIG_PCI_HCI */

	#if (PHL_MEM_SIZE_LEVEL > _PHL_MEM_SIZE_MIN_)
		#define DBG_DUMP_CMAC_CFG_INFO
		#define DBG_MONITOR_TIME
		#define CONFIG_PHL_TID_RX_DROP_INFO
	#endif
...
#ifdef CONFIG_CORE_PHL_CHECK_IV
#define CONFIG_PHL_TID_RX_IV_CHK
#endif
...
#ifdef CONFIG_RTW_PCIE_TX_CB_WQ
#define CONFIG_PHL_PCIE_TX_CB_WQ
#endif
#ifdef CONFIG_RTW_PCIE_RX_CB_WQ
#define CONFIG_PHL_PCIE_RX_CB_WQ
#endif
#ifdef CONFIG_RTW_EVENT_CB_WQ
#define CONFIG_PHL_EVENT_CB_WQ
#endif
...
/* halrf control pwr_lmt/pwr_by_rate by rfe_type */
/* BIT0: unknown */
/* BIT1:RFE_TYPE1, BIT2:RFE_TYPE2 ~ BIT6:RFE_TYPE6*/
/* 0xFFFFFFFF: all of rfe_type */
#if !defined(RFE_TYPE1_31_SUPPORT) && !defined(RFE_TYPE32_63_SUPPORT) && \
    !defined(RFE_TYPE64_95_SUPPORT)
	#define RFE_TYPE1_31_SUPPORT 0xFFFFFFFF
	#define RFE_TYPE32_63_SUPPORT 0xFFFFFFFF
	#define RFE_TYPE64_95_SUPPORT 0xFFFFFFFF
#endif
#ifdef RFE_TYPE1_31_SUPPORT
	#define CONFIG_RFE_TYPE1_31 RFE_TYPE1_31_SUPPORT
#endif
#ifdef RFE_TYPE32_63_SUPPORT
	#define CONFIG_RFE_TYPE32_63 RFE_TYPE32_63_SUPPORT
#endif
#ifdef RFE_TYPE64_95_SUPPORT
	#define CONFIG_RFE_TYPE64_95 RFE_TYPE64_95_SUPPORT
#endif
