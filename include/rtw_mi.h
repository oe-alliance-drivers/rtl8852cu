...
#define IFBMP_TO_IFLBMP(ifbmp) (ifbmp & (BIT(CONFIG_IFACE_NUMBER) - 1)) /* this driver has single link only */
#define IFLBMP_TO_IFBMP(iflbmp) (iflbmp & (BIT(CONFIG_IFACE_NUMBER) - 1)) /* this driver has single link only */
